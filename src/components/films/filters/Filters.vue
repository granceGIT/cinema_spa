    ...
    <form class="filters-form">
        <div class="filters-body">
            ...
            <div class="filter-block">
                ...
                <ul class="filter-list">
                    <li>
                        <input type="checkbox" :value="dateToSQL(new Date())" @input="updateDateFilters" name="date"
                               id="date1" class="custom-check">
                        <label for="date1" class="filter-check-card">Сегодня</label>
                    </li>

                    <li>
                        <input type="checkbox" :value="dateToSQL(addDaysToDate(new Date(),1))"
                               @input="updateDateFilters" name="date" id="date2" class="custom-check">
                        <label for="date2" class="filter-check-card">Завтра</label>
                    </li>

                    <li>
                        <input type="checkbox" :value="dateToSQL(addDaysToDate(new Date(),2))"
...
import {addDaysToDate, dateToSQL} from "@/utils";
